...
friend may look at exactly once. A drink is deleted after 24 hours and leaves a mate's feed two hours after they first see it; only your newest one shows: logging again replaces it (Tim, 2026-09-11; one hour since 2026-09-16). Success: a group of
...
3. Ephemeral by design: seen-then-two-hours, one live drink per person, and view-once are features; the UI should make them legible.
