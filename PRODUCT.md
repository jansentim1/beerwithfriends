...
friend may look at exactly once. A drink stays one hour, and only your newest one shows: logging again replaces it (Tim, 2026-09-11; one hour since 2026-09-16). Success: a group of
...
- Photos: camera only, JPEG ≤ 1080 px, 1 h, view once per friend, screenshot receipts.
...
3. Ephemeral by design: one hour, one live drink per person, and view-once are features; the UI should make them legible.
