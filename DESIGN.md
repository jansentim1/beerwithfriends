---
name: PubDates
description: A row of drawn glasses; tap one and your mates hear it; each glass empties in 15 minutes, the row stays an hour.
colors:
  pint-amber: "#E68A00"
...
- **Level:** 0 is empty, 1 is the brim. Unlogged glasses rest at 0 (Tim: "all glasses should be empty unless filled"). A logged drink starts at 1 and drains linearly to 0 over 15 minutes; the row and the pin stay for an hour.
